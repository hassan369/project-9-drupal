...
class __TwigTemplate_583da0bd6f12aa90fcd4360d0d16bd1e extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/profiles/demo_umami/themes/umami/templates/classy/content-edit/filter-tips.html.twig", "C:\\xampp\\htdocs\\course\\core\\profiles\\demo_umami\\themes\\umami\\templates\\classy\\content-edit\\filter-tips.html.twig");
    }
